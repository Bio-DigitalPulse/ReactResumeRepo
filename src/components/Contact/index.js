                ...
                <div className="row justify-content-center">
                    ...
                    <h2 className="text-white text-center mb-5 contact">Feel Free to Contact</h2>
                        ...
                        <div className="col-sm-4 ml-auto contact-btn">
                            <a className="text-decoration-none text-white" href="https://www.linkedin.com/in/aaron-keller-b54941212" target="blank"><i
                        ...
                        <div className="col-sm-4 ml-auto contact-btn">
                            <a className="text-decoration-none text-white" href="mailto:aaron.k.keller@gmail.com" target="blank"><i class="fas fa-envelope-open-text fa-4x"></i>
